				...
				<div class="ec-content-wrapper">
					<div class="content">
						<div class="breadcrumb-wrapper breadcrumb-wrapper-2 breadcrumb-contacts">
							...
							<span><i class="mdi mdi-chevron-right"></i></span>Add Slots
								...
								<div class="ec-cat-list card card-default mb-24px">
									<div class="card-body">
										<div class="ec-cat-form">
											...
											<form action="{{route('add.slots')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
												
												<div class="form-group row">
													<label for="text" class="col-12 col-form-label">From Range</label>
													<div class="col-12">
														<input id="number" name="from_range" class="form-control here slug-title"  type="time" placeholder="Enter From Range" required>
													</div>
												</div>
												<div class="form-group row">
													<label for="text" class="col-12 col-form-label">To Range</label>
													<div class="col-12">
														<input  name="to_range" class="form-control here slug-title"  type="time" placeholder="Enter To Range" required>
													</div>
												</div>
