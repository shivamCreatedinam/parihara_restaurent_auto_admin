		...
		<div class="ec-page-wrapper">
            ...
            @endif
                <div class="breadcrumb-wrapper breadcrumb-contacts">
						...
						<div>
							<a href="{{url('sysadmin/add-sub-category')}}"><button type="button" class="btn btn-primary" > Add Sub Category
													...
													<td>
														<div class="btn-group">
															...
															<div class="dropdown-menu">
																<a class="dropdown-item" href="{{url('sysadmin/edit-sub-category/'.$value->id)}}">Edit</a>
																<a class="dropdown-item" href="{{url('sysadmin/delete-sub-category/'.$value->id)}}" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
															</div>
														</div>
													</td>
												</tr>
