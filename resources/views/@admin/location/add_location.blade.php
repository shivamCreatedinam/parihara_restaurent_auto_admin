				...
				<div class="ec-content-wrapper">
					<div class="content">
						<div class="breadcrumb-wrapper breadcrumb-wrapper-2 breadcrumb-contacts">
							...
							<span><i class="mdi mdi-chevron-right"></i></span>Add Location
										...
										<div class="ec-cat-form">
											...
											<form action="{{route('add.location')}}" method="POST" enctype="multipart/form-data">
												...
												<div class="form-group row">
													...
													<div class="col-12">
														<input id="text" name="region" class="form-control here slug-title"  type="text" placeholder="Enter Region Name" required>
													</div>
												</div>
												<div class="form-group row">
													<label for="text" class="col-12 col-form-label">Pincode</label>
													<div class="col-12">
														<input id="text" name="pincode" class="form-control here slug-title"  type="text" placeholder="Enter Pincode" required>
													</div>
												</div>
