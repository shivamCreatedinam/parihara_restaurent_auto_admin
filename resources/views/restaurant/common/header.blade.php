						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown user-menu">
								<button class="dropdown-toggle nav-link ec-drop" data-bs-toggle="dropdown"
									aria-expanded="false">
									<img src="{{asset('uploads/user_image/user.png')}}" class="user-image" alt="User Image" />
								</button>
								<ul class="dropdown-menu dropdown-menu-right ec-dropdown-menu">
									<!-- User image -->
									<li class="dropdown-header">
										<img src="{{asset('uploads/user_image/user.png')}}" class="img-circle" alt="User Image" />
										<div class="d-inline-block">
											<?php 
                                            if (Session::get('REST') !='') {
                                                echo Session::get('REST');
                                            }
                                            ?> <small class="pt-1"><?php 
                                            if (Session::get('RESTEMAIL') !='') {
                                                echo Session::get('RESTEMAIL');
                                            }
                                            ?></small>
										</div>
									</li>
									 <li>
										<a href="{{url('restaurant/my-profile')}}">
											<i class="mdi mdi-account"></i> My Profile
										</a>
									</li>
									
									<li >
										<a href="{{url('restaurant/change-password')}}"> <i class="mdi mdi-settings-outline"></i> Change Password </a>
									</li> 
									<li class="dropdown-footer">
										<a href="{{url('restaurant/logout')}}"> <i class="mdi mdi-logout"></i> Log Out </a>
									</li>
								</ul>
							</li>
