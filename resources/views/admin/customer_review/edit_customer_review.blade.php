				...
				<div class="ec-content-wrapper">
					<div class="content">
						<div class="breadcrumb-wrapper breadcrumb-wrapper-2 breadcrumb-contacts">
							...
							<span><i class="mdi mdi-chevron-right"></i></span> Edit Customer
								...
								<div class="ec-cat-list card card-default mb-24px">
									<div class="card-body">
										<div class="ec-cat-form">
											...
											<form action="{{route('edit.customerreview')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
											
												<div class="form-group row">
													<label for="text" class="col-12 col-form-label">Customer Name</label>
													<div class="col-12">
														<input id="text" name="customer_name" value="{{$data->name}}" class="form-control here slug-title" type="text" placeholder="Enter Customer Name">
													</div>
												</div>
												<div class="form-group row">
													<label for="text" class="col-12 col-form-label">Occupation</label>
													<div class="col-12">
														<input id="text" name="occupation" value="{{$data->occupation}}"  class="form-control here slug-title" type="text" placeholder="Enter Occupation">
													</div>
												</div>
												<div class="form-group row">
													<label for="text" class="col-12 col-form-label">Review</label>
													<div class="col-12">
														<textarea id="text" name="review" class="form-control here slug-title" type="text" placeholder="Enter Review">{{$data->reviews}}</textarea>
													</div>
												</div>
