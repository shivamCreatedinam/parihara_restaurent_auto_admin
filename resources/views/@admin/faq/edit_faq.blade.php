				...
				<div class="ec-content-wrapper">
					<div class="content">
						<div class="breadcrumb-wrapper breadcrumb-wrapper-2 breadcrumb-contacts">
							...
							<span><i class="mdi mdi-chevron-right"></i></span> Edit FAQ
							...
							<div class="col-xl-12 col-lg-12">
								<div class="ec-cat-list card card-default mb-24px">
									<div class="card-body">
										...
										<form action="{{route('edit.faq')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
												<div class="form-group row">
													<label for="text" class="col-12 col-form-label">Question</label>
													<div class="col-12">
														<textarea id="text" name="questions" class="form-control here slug-title" type="text" placeholder="Enter Question">{{$data->questions}}</textarea>
												...
												<div class="form-group row">
													...
													<div class="col-12">
														<textarea id="text" name="answer" class="form-control here slug-title" type="text" placeholder="Enter Answer">{{$data->answer}}</textarea>
