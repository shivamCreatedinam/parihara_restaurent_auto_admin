								...
								<div class="ec-cat-list card card-default mb-24px">
									<div class="card-body">
										<div class="ec-cat-form">
											...
											<form action="{{route('edit.subcategory')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
												...
												<div class="form-group row">
													...
													<div class="col-12">
														<input id="text" name="title" class="form-control here slug-title" value="{{$data->sub_category_name}}" type="text" placeholder="Enter  Sub Category Name">
													</div>
												</div>
                                                <div class="form-group row">
