                ...
                <div class="breadcrumb-wrapper breadcrumb-contacts">
						<div>
							...
							<p class="breadcrumbs"><span><a href="{{url('sysadmin/dashboard')}}">Home</a></span>
								<span><i class="mdi mdi-chevron-right"></i></span>Restaurant List
							</p>
							 
						</div>
						
						<div>
						    	<a href="{{url('sysadmin/add-restaurant')}}"><button type="button" class="btn btn-primary" > Add Restaurant
					...
					<div class="row">
						...
						<div class="col-xl-12 col-lg-12">
							<div class="ec-cat-list card card-default">
								<div class="card-body">
								<form action="{{url('sysadmin/restaurant-list')}}" method="get">
								<div class="row">
								...
								<div class="col-md-3">
									...
									<a href="{{url('sysadmin/restaurant-list')}}"><button type="button"  class="btn btn-success" style="margin-top: 27px;"> Reset
                        			</button></a>
									</div>
								</div>	
								</form>
											...
											<tbody>
                                                ...
                                                <tr>
													...
													<td><?php 
                                                        if($value->status == '1'){
                                                            ?>
															<a href="{{url('sysadmin/restaurant-status/0/'.$value->id)}}"><span class="badge badge-success">Active</span></a>
                                                        <?php
                                                        }
                                                        if($value->status == '0'){
															?>
															<a href="{{url('sysadmin/restaurant-status/1/'.$value->id)}}"><span class="badge badge-danger">InActive</span></a>
                                                        <?php
                                                        }
                                                    ?></td>
													...
													<td>
														<div class="btn-group">
															...
															<div class="dropdown-menu">
																<a class="dropdown-item" href="{{url('sysadmin/edit-restaurant/'.$value->id)}}">View Details</a>
