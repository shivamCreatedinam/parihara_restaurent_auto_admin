                ...
                <div class="breadcrumb-wrapper breadcrumb-contacts">
						<div>
							...
							<p class="breadcrumbs"><span><a href="{{url('sysadmin/dashboard')}}">Home</a></span>
								<span><i class="mdi mdi-chevron-right"></i></span>Report  List
							</p>
						</div>
						<div>
					...
					<div class="row">
						...
						<div class="col-xl-12 col-lg-12">
							<div class="ec-cat-list card card-default">
								...
								<form action="{{url('sysadmin/report')}}" method="get">
									<div class="row">
									...
									<div class="col-md-4">
										...
										<button type="button"  class="btn btn-success" style="margin-top: 27px;"> Export
										</button>
										<a href="{{url('sysadmin/report')}}"><button type="button"  class="btn btn-success" style="margin-top: 27px;"> Reset
                        			</button></a>
										</div>
									</div>	
