									...
									<li class="dropdown-header">
										...
										<div class="d-inline-block">
                                            ...
                                            if (Session::get('ADMINEMAIL') !='') {
                                                echo Session::get('ADMINEMAIL');
                                            }
                                            ?></small>
										</div>
									</li>
									 <li>
										<a href="{{url('sysadmin/my-profile')}}">
											<i class="mdi mdi-account"></i> My Profile
										</a>
									</li>
									
									<li >
										<a href="{{url('sysadmin/change-password')}}"> <i class="mdi mdi-settings-outline"></i> Change Password </a>
									</li> 
									<li class="dropdown-footer">
										<a href="{{url('sysadmin/logout')}}"> <i class="mdi mdi-logout"></i> Log Out </a>
									</li>
								</ul>
							</li>
