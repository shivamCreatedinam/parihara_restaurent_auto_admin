...
<html lang="en" dir="ltr">
	<head>
		...
		<title>Edit Sub Sub Category</title>
		<!-- GOOGLE FONTS -->
				...
				<div class="ec-content-wrapper">
					<div class="content">
						<div class="breadcrumb-wrapper breadcrumb-wrapper-2 breadcrumb-contacts">
							...
							<span><i class="mdi mdi-chevron-right"></i></span> Edit Sub Sub Category
								...
								<div class="ec-cat-list card card-default mb-24px">
									<div class="card-body">
										<div class="ec-cat-form">
											...
											<form action="{{route('edit.subsubcategory')}}" method="POST" enctype="multipart/form-data">
                                                @csrf
												...
												<div class="form-group row">
													...
													<div class="col-12">
														...
														foreach ($subcategory as $key => $svalue) {
															?>
															<option value="<?=$svalue->id?>" <?php 
															if ($svalue->id == $data->sub_category_id) {
																echo 'selected';
															}
															?>><?=$svalue->sub_category_name?></option>
															<?php
														}
														?>
														</select>
												...
												<div class="form-group row">
													...
													<div class="col-12">
														<input id="text" name="title" class="form-control here slug-title" value="{{$data->sub_sub_category_name}}" type="text" placeholder="Enter Sub Sub Category Name">
													</div>
												</div>
                                                <div class="form-group row">
