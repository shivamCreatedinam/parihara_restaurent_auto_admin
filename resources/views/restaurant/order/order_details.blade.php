            ...
            <div class="ec-content-wrapper">
                <div class="content">
                    ...
                    <div class="breadcrumb-wrapper breadcrumb-wrapper-2">
                        <h1>Order Details</h1>
                        <p class="breadcrumbs"><span><a href="{{url('sysrestaurant/dashboard')}}">Home</a></span>
                            ...
                            <div class="ec-odr-dtl card card-default">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <form action="{{route('update.restaurant.order_status')}}" method="post">
                                                @csrf
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="order_status" class="form-control" id=""  onchange="changeOrderStatus(this.value)" required>
                                                        <option value="">Select Status</option>
                                                        <?php 
												$status = order_status();
												foreach ($status as  $value) {
												    if($value->order_status !== 'Returned'){
													?>
                                                ...
                                                ?>
                                                <div class="form-group showdelv" style="<?=$delsts?>">
                                                    <label>Assign Delivery Boy</label><select name="delivery_boy" class="form-control" id="" ><option value="">Select One</option><?php foreach ($delivery_boy as  $value) {?><option value="{{$value->id}}" <?php if ($value->id == $data->delivery_boy_id) {echo "selected"; } ?>>{{$value->unique_id}} - {{$value->name}}</option><?php } ?></select>
                                                </div>
                                                <div class="form-group showCancel" style="<?=$Reems?>">
                                                    <label>Remark</label>
                                                    <textarea placeholder="Enter Remark" class="form-control" name="cancel_remark">{{$data->cancel_remark}}</textarea>
                                                </div>
                                                <div class="form-group">
            ...
            <script>
                function changeOrderStatus(value){
                    if(value=='Out For Delivery'){
                        $('.showdelv').css("display", "block");
                        $("select[name=delivery_boy]").attr("required", true);
                    }else if(value=='Canceled'){
                         $('.showCancel').css("display", "block");
                        $('.showdelv').css("display", "none");
                        
                    }else{
                        $("select[name=delivery_boy]").attr("required", false);
                        $('.showdelv').css("display", "none");
