                                        ...
                                        <form action="{{route('edit.inventory')}}" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-12 ">
                                                    ...
                                                    <div class="col-12">
                                                        <input name="product_name" value="{{$data->product_name}}" class="form-control here slug-title"
                                                            type="text" placeholder="Enter Product Name" readonly />
                                                ...
                                                <div class="form-group col-6 ">
                                                    ...
                                                    <div class="col-12">
                                                        <input name="qty" value="{{$data->qty}}"  class="form-control here slug-title"
                                                ...
                                                <div class="form-group col-6 ">
                                                    <label for="text" class="col-12 col-form-label">Return
                                                        Quantity</label>
                                                    <div class="col-12">
                                                        <input name="return_qty" value="{{$data->return_qty}}" class="form-control here slug-title"
                                                ...
                                                <div class="form-group col-6 ">
                                                    <label for="text" class="col-12 col-form-label">Stolen
                                                        Product</label>
                                                    <div class="col-12">
                                                        <input name="stolen_product" value="{{$data->stolen_product}}"
