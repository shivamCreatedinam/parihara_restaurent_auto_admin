		...
		<div class="ec-page-wrapper">
            ...
            @endif
                <div class="breadcrumb-wrapper breadcrumb-contacts">
						...
						<div>
							<!-- <a href="{{url('restaurant/add-coupon')}}"><button type="button" class="btn btn-primary" > Add Coupon
					...
					<div class="row">
						...
						<div class="col-xl-12 col-lg-12">
							<div class="ec-cat-list card card-default">
								...
								<form action="{{url('restaurant/orders')}}" method="get">
									<div class="row">
									...
									<div class="col-md-3">
										...
										<a href="{{url('restaurant/orders')}}"><button type="button"  class="btn btn-success" style="margin-top: 27px;"> Reset
                        			</button></a>
										</div>
									</div>	
									</form>
											...
											<tbody>
												...
												foreach ($data as  $value) {
													...
													<tr>
														...
														<td><a href="{{url('restaurant/view-order-details/'.$value->id)}}"><button type="button" class="btn btn-sm btn-primary">View</button></a></td>
													</tr>
													<?php
													$x++;
												}
