										...
										<div class="ec-cat-form">
											...
											<form action="{{route('edit.banner')}}" method="POST" enctype="multipart/form-data">
												...
												<div class="form-group row">
													...
													<div class="col-12">
														<input id="text" name="title" class="form-control here slug-title" value="{{$data->title}}" type="text" placeholder="Enter Title" >
														<input type="hidden" value="Banner" name="slider_type">
													</div>
												</div>
                                                <div class="form-group row">
